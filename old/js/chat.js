(function () {
    ...
    app.querySelector(".join-screen #username").addEventListener(
        "keypress",
        function (e) {
            if (e.key === "Enter") {
                let username = app.querySelector(
                    ".join-screen #username"
                ).value;
                if (username.length == 0) {
                    return;
                }
    ...
    app.querySelector(".chat-screen #message-input").addEventListener(
        "keypress",
        function (e) {
            if (e.key === "Enter") {
                let message = app.querySelector(
...
t.addEventListener("input", (event) => {
    if (document.querySelector("#username").value.length === 12) {
        document.querySelector(".error").innerHTML =
            '<label style="color: red">Osiągnięto limit znaków!</label>';
